      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#contact" className="bg-gradient-to-r from-premium-600 to-electric-600 hover:opacity-90 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 hover:scale-105 premium-glow">
              Let's Talk
            </a>
          </div>
