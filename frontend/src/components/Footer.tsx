export default function Footer() {
  return (
    <footer className="bg-gray-950 border-t border-white/10" data-testid="footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-white/10 pt-8">
          <p className="text-gray-500 text-sm text-center" data-testid="copyright">© 2026 Digital Dream Works Agency. Part of Digital Dream Works LLC. All rights reserved.<br /><span className="text-xs">Florida, USA | Rome, Italy</span></p>
        </div>
      </div>
    </footer>
  )
