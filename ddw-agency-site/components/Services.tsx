          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-gradient-to-br from-gray-900/50 to-gray-900/30 border border-gray-800/50 rounded-2xl p-6 hover:border-agency-600/50 transition-all duration-300 hover:scale-105"
              >
                {/* Gradient on hover */}
